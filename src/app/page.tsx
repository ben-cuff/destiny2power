    ...
    <main className="flex flex-col items-center justify-center min-h-screen bg-gray-800">
      {sessionData ? (
        <div className="flex flex-col items-center">
          ...
          <button
            className="mt-8 rounded-full bg-red-600 px-10 py-3 font-semibold text-white hover:bg-red-700"
        ...
        <div className="text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            This is a Destiny 2 power level tracking app. You can use it to track your power level and see what you should do next.</p>
            <p className="text-xl text-gray-300 mb-8">
